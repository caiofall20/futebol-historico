    ...
    function selectCountry(countryId) {
        ...
        const country = countryData[countryId] || { 
            ...
            info: "Informações não disponíveis." 
               ...
               $('#stat-goals').text(country.goals);
               $('#stat-matches').text(country.matches);
               
               // Atualizar informações importantes (apenas campos mantidos)
               $('#best-result').text(country.bestResult || 'N/A');
               $('#legendary-players').text(country.legendaryPlayers || 'N/A');
               $('#home-stadium').text(country.homeStadium || 'N/A');
               
               // Atualizar títulos continentais (Copa América ou Eurocopa)
               let continentalTitles = 'N/A';
               if (country.copaAmerica && country.copaAmerica !== '0 títulos') {
                   continentalTitles = `Copa América: ${country.copaAmerica}`;
               } else if (country.euroChampionship && country.euroChampionship !== '0 títulos') {
                   continentalTitles = `Eurocopa: ${country.euroChampionship}`;
               }
               $('#continental-titles').text(continentalTitles);
        ...
        // Exibe o card de informações com o tema do país
